    ...
    return(
        <div className="bg-gray-900 h-96   text-white flex items-center justify-between">
            <div className="mx-10">
                ...
                <p className="">Far far away, behind the word<br/> mountains, far from the <br/> countries Vokalia and<br/> Consonantia, there live the <br/> blind texts.</p>
                <div className="flex text-2xl ">
                <a href=""><FaSquareXTwitter className="mx-2 transition-all duration-500 ease-in-out transform hover:text-4xl "/></a>
